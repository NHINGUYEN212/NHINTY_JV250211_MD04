package ra.com.exercise03and04.service;
...
public class ProductService {
    ...
    public List<Product> searchProductsByName(String searchProductName) {
        if (searchProductName == null || searchProductName.isEmpty()) {
            ...
            return products.stream().filter(product -> product.getProductName().toLowerCase().contains(searchProductName.toLowerCase())).collect(Collectors.toList());
        }
    }
}
